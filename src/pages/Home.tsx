...
const toolKeys = ["clip-path", "gradient", "shadow", "radius"] as const;
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  shadow: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="3" width="18" height="18" rx="3" /><rect x="5" y="5" width="14" height="14" rx="2" opacity="0.35" />
    </svg>
  ),
  radius: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
      <rect x="3" y="3" width="18" height="18" rx="7" /><circle cx="7" cy="7" r="1" fill="currentColor" stroke="none" />
    </svg>
  ),
};

const gradientMap: Record<string, string> = {
  "clip-path": "from-rose-400 via-violet-500 to-indigo-500",
  gradient: "from-amber-400 via-orange-500 to-rose-500",
  shadow: "from-sky-400 via-blue-500 to-indigo-600",
  radius: "from-emerald-400 via-teal-500 to-cyan-600",
};
    ...
    <div className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="grid grid-cols-2 gap-3">
        {toolKeys.map((key) => {
          ...
          const path = key === "radius" ? "/border-radius" : `/${key}`;
      ...
      <div className="mt-20 text-center">
        ...
        <p className="mt-2">
          <a href="https://github.com/lov-alt/css-visual-toolbox" target="_blank" rel="noopener noreferrer"
